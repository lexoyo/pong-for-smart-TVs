...
org.games.pong.engine.MovingObject = function(timeline) { if( timeline === $_ ) return; {
	this.MARGIN_H = 220;
	this.MARGIN_V = 200;
...
org.games.pong.pong.Bat = function(timeline) { if( timeline === $_ ) return; {
...
org.games.pong.Main = function(p) { if( p === $_ ) return; {
...
org.games.pong.pong.Ball = function(timeline) { if( timeline === $_ ) return; {
	org.games.pong.engine.MovingObject.call(this,timeline);
...
org.games.pong.pong.Ball.prototype.update = function() {
	...
	if(this.x <= this.MARGIN_H) if(this.onTouchLeftSide != null) this.onTouchLeftSide();
	if(this.x + this.imageDOMElement.getWidth() >= this._timeline.getWidth() - this.MARGIN_H) if(this.onTouchRightSide != null) this.onTouchRightSide();
	if(this.y <= 0) if(this.onTouchTopSide != null) this.onTouchTopSide();
	if(this.y + this.imageDOMElement.getHeight() >= this._timeline.getHeight()) if(this.onTouchBottomSide != null) this.onTouchBottomSide();
}
...
org.games.pong.pong.PongGame = function(p) { if( p === $_ ) return; {
...
org.games.pong.pong.PongGame.prototype.followMousePosition = function() {
	if(this._mouseY > this._bat01.y + this._bat01.imageDOMElement.getHeight() / 2) this.goDown();
	else this.goUp();
}
...
org.games.pong.pong.PongGame.prototype.onKeyDown = function(key) {
	if(key.value == cocktail.keyboard.KeyboardKeyValue.down) this.goDown();
	else if(key.value == cocktail.keyboard.KeyboardKeyValue.up) this.goUp();
}
org.games.pong.pong.PongGame.prototype.mainLoop = function() {
	this._ball.update();
	this._bat01.update();
	if(this._ball.y < this._bat02.y + 20) this._bat02.accelY -= Math.random() * 3.6;
	else if(this._ball.y > this._bat02.y + this._bat02.imageDOMElement.getHeight() - 20) this._bat02.accelY += Math.random() * 3.6;
	this._bat02.update();
